      ...
      <div className={styles.card__wrapper}>
        <div className={styles.card__item}>
          <div className={styles.card__body}>
            {choice ? (
              <input
                className={styles.card__customCheckbox}
                type="checkbox"
                value="+"
              />
            ) : (
            ...
            <div className={styles.card__content}>
              ...
              <div className={styles.card__location}>
                <div className={styles.card__locationTitle}>
                  Регион производства
                </div>
                <div className={styles.card__address}>{props.region}</div>
              </div>
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <stop offset="1" stopColor="#D57300" />
                          <stop offset="1" stopColor="#D57300" />
                        </linearGradient>
                      </defs>
                    </svg>
              ...
              <div className={styles.card__button}>
                <div className={styles.card__catalog}>
                  <Link href="/profile/catalog">Каталог компании</Link>
                </div>
                <div
                  onClick={() => setActiveInfo(!activeInfo)}
                  className={styles.card__about}
                >
                  <span>Подробнее</span>
                  {activeInfo ? (
                    <svg
          ...
          <div
            className={
              activeInfo
                ? [styles.card__fullInfo, styles.card__fullInfo_active].join(
                    " "
                  )
                : styles.card__fullInfo
            }
          >
            <div className={styles.card__fullInfoBody}>
              <div className={styles.card__fullInfoItem}>
                ...
                <div className={styles.card__fullInfoSubTitle}>
                  {props.cut_name}
                </div>
              </div>
              <div className={styles.card__fullInfoItem}>
                <div className={styles.card__fullInfoTitle}>ИНН</div>
                <div className={styles.card__fullInfoSubTitle}>{props.inn}</div>
              </div>
              <div className={styles.card__fullInfoItem}>
                <div className={styles.card__fullInfoTitle}>Телефон</div>
                <div className={styles.card__fullInfoSubTitle}>...</div>
              </div>
              <div className={styles.card__fullInfoItem}>
              ...
              <div
                className={[
                  styles.card__fullInfoItem,
                  styles.card__fullInfoItem_link,
                ].join(" ")}
              >
                <div className={styles.card__fullInfoSubTitle}>
                  Сайт компании
              ...
              <div className={styles.card__buttonInfo}>
                <div className={styles.card__buttonItem}>
                  <div className={styles.card__buttonItemTitle}>
            ...
            {recommendation ? (
              ...
              >
                <div
                  className={styles.card__recommendationBody}
                  style={{
                    background: "#0036FF",
                    width: "65.2%",
            ...
            <div
              ...
              style={
                choice
                  ...
                  : {
                      background:
                        "linear-gradient(135deg, #FF8A00 0%, #D47300 100%, #D47300 100%), #242424",
                      color: "#FFF",
                    }
              }
            >
