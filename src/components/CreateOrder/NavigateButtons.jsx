  ...
  return (
    ...
    <div className={styles.form__button}>
      ...
      <button
        ...
        >
          {stage == stagesCount - 1 ? (isEditMode ? 'Сохранить' : 'Отправить') : 'Вперед'}
        </button>
    </div>
    {(!isPhotoUrlsExist && stage == 5) ? <p className={styles.form__errorMess}>Заполните поле "Фото изделия" на первой стадии</p> : ''}
    </>
  );
};
