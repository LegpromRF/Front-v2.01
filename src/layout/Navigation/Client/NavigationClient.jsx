...
import ButtonLogout from "../../../components/UI/ButtonLogout/ButtonLogout";
import { toggleNav, setNav } from "@store/navigation/navigation.slice";
    ...
    <>
      ...
      >
        <nav
          ...
          className={
            isNavOpen ? [styles.nav, styles.nav__active].join(" ") : styles.nav
          }
        >
          <div className={styles.nav__content}>
            ...
            <div className={styles.nav__buttons}>
              <ButtonNavigation title="Все возможности" href="/profile ">
                <svg
