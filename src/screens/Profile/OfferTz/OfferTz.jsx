        ...
        <div className={styles.offer}>
          ...
          <div className={styles.offer__head}>
            <div className={styles.offer__ico}>
              <Image src={icon} alt="Иконка" width={100} height={100} />
            </div>
            <div className={styles.offer__content}>
              <div className={styles.offer__info}>
                <div className={styles.offer__name}>
                  Пошив платья для официантов
                </div>
                ...
                <div className={styles.offer__items}>
                  <div className={styles.offer__controlItem}>
                    <Link href="/profile/checkTz/">
                      <div className={styles.offer__controlTitle}>
                        Посмотреть ТЗ
                      </div>
            ...
            <div className={styles.offer__right}>
              <h3 className={styles.offer__headText}>
                Сопроводительное письмо добавляет шанс найма
              </h3>
              <div className={styles.offer__respond}>
                <Link href="/profile/offer">Отправить</Link>
              </div>
            </div>
          </div>
          <div className={styles.offer__inputs}>
            ...
            <div className={styles.offer__items}>
              <div className={styles.offer__item}>
                <input
                  className={activeInput1 ? styles.offer__activeInput : ""}
                  type="text"
              ...
              <div className={styles.offer__item}>
                <input
                  className={activeInput2 ? styles.offer__activeInput : ""}
                  type="text"
                  placeholder="Бюджет на работу"
                  onChange={handleChange2}
                />
              </div>
              <div className={styles.offer__item}>
                <input
                  className={activeInput3 ? styles.offer__activeInput : ""}
                  type="text"
          ...
          <div className={styles.offer__mail}>
            <div className={styles.offer__mailTitle}>
              Сопроводительное письмо
            </div>
            <textarea
              className={styles.offer__mailTextarea}
              cols="30"
              rows="10"
