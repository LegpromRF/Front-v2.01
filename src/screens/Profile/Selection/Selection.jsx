      ...
      <div className={styles.selection}>
        ...
        <div className={styles.selection__content}>
          <div className={styles.selection__info}>
            <div className={styles.selection__name}>
              Ваше ТЗ: Пошив платья для официантов
            </div>
          ...
          <div className={styles.selection__control}>
            <div className={styles.selection__items}>
              <div className={styles.selection__controlItem}>
                <Link to="/profile/checkTz/">
                  <div className={styles.selection__controlTitle}>
                    Просмотреть ТЗ
                  </div>
            ...
            {choice ? (
              <div className={styles.selection__respond}>
                <Link href="/profile/selection/">Отправить выбранным</Link>
              </div>
            ) : (
              <div className={styles.selection__respond_orange}>
                <Link href="/profile/selection/">Отправить заявку всем</Link>
              </div>
            )}
          </div>
        </div>
        <div className={styles.selection__search}>
          <span>
            Найдено {companiesID.length} исполнителей согласно критериям:
          </span>
          {choice ? (
            <div
              onClick={() => setChoice(false)}
              className={styles.selection__searchBtn}
            >
              Отменить выбор
            </div>
          ) : (
            <div
              ...
              className={styles.selection__searchBtnChoice}
            >
              Выбрать несколько
            </div>
          )}
